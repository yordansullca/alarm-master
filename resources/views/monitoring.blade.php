...
<div id="pageHr">
    ...
    <div class="charts-wrap">
        <div class="chart" id="temperaturemonitoring1">
            <h1 id="textmonitoring">Sensor de temperatura</h1>
            <canvas id="temperaturemonitoringchart1" width="400" height="400"></canvas>
        </div>
        <div class="chart" id="comonitoring1">
            <h1 id="textmonitoring2">Sensor CO.</h1>
            <canvas id="comonitoringchart1" width="400" height="400"></canvas>
        </div>
        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn btn-danger btn-lg" id="btnEnviar">Activar alarma manualmente</button>
...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     function enviar(){
            ...
            alert("La alarma fue activada evacúe!!");
